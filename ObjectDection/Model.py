...
yolov3_weights = '/Users/skmirajulislam/Documents/MyPython/ML/ObjectDection/Data/yolov3.weights'
yolov3_cfg = '/Users/skmirajulislam/Documents/MyPython/ML/ObjectDection/Data/yolov3.cfg'
min_confidence = 0.2  # Adjust this threshold as needed

net = cv2.dnn.readNet(yolov3_weights, yolov3_cfg)
np.random.seed(543210)
classes = []
with open('/Users/skmirajulislam/Documents/MyPython/ML/ObjectDection/Data/coco.txt', 'r') as f:
        ...
        for detection in detected_objects:
            for obj in detection:
                ...
                if confidence > min_confidence:
                    ...
                    cv2.putText(image, prediction_text, (upper_left_x, upper_left_y - 15 if upper_left_y > 30 else upper_left_y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.6, colors[class_id], 2)
